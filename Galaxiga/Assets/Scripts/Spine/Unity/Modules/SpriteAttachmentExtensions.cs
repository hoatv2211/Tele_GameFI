...
namespace Spine.Unity.Modules
{
	public static class SpriteAttachmentExtensions
	{
		...
		{
			RegionAttachment regionAttachment = (!applyPMA) ? sprite.ToRegionAttachment(new Material(shader), 0f) : sprite.ToRegionAttachmentPMAClone(shader, TextureFormat.RGBA32, false, null, 0f);

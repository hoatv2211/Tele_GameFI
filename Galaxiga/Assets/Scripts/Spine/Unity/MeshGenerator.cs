...
namespace Spine.Unity
{
	...
	public class MeshGenerator
	{
		...
		public void BuildMeshWithArrays(SkeletonRendererInstruction instruction, bool updateTriangles)
		{
			...
			int num = 0;
			float[] array = this.tempVerts;
			Vector3 v = this.meshBoundsMin;
			Vector3 v2 = this.meshBoundsMax;
			...
			this.meshBoundsMin = v;
			this.meshBoundsMax = v2;
		...
		public void FillVertexData(Mesh mesh)
		{
			...
			{
				Vector2 b = (this.meshBoundsMax - this.meshBoundsMin) * 0.5f;
				mesh.bounds = new Bounds
				{
					center = this.meshBoundsMin + b,
					extents = new Vector3(b.x, b.y, this.meshBoundsThickness * 0.5f)
				};
			}

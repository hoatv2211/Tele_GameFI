	...
	public class SkeletonBinary
	{
		...
		public SkeletonData ReadSkeletonData(Stream input)
		{
			...
			while (j < num2)
			{
				...
				slotData.r = (float)(((long)num3 & (long)((ulong)0xFF000000u)) >> 24) / 255f;
		...
		private Attachment ReadAttachment(Stream input, SkeletonData skeletonData, Skin skin, int slotIndex, string attachmentName, bool nonessential)
		{
			...
			case 0:
			{
				...
				regionAttachment.r = (float)(((long)num5 & (long)((ulong)0xFF000000u)) >> 24) / 255f;
			...
			case 2:
			{
				...
				meshAttachment.r = (float)(((long)num7 & (long)((ulong)0xFF000000u)) >> 24) / 255f;
			...
			case 3:
			{
				...
				meshAttachment2.r = (float)(((long)num12 & (long)((ulong)0xFF000000u)) >> 24) / 255f;
					...
					if (num4 != 0)
					{
						if (num4 != 1)
						{
							if (num4 == 2)
							{
								...
								for (int k = 0; k < num5; k++)
								{
									...
									float r = (float)(((long)num6 & (long)((ulong)0xFF000000u)) >> 24) / 255f;
						...
						else
						{
							...
							for (int l = 0; l < num5; l++)
							{
								...
								float r3 = (float)(((long)num8 & (long)((ulong)0xFF000000u)) >> 24) / 255f;
